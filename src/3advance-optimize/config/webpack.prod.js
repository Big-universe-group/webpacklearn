...
module.exports = {
  ...
  optimization: {
    ...
    minimizer: [
      // 压缩css
      new CssMinimizerPlugin(),
      // 压缩js, 如果不使用多进程, 这个插件默认webpack会使用, 不需要额外配置.
      new TerserWebpackPlugin({
        parallel: threads, // 开启多进程和设置进程数量
      }),
      // 压缩图片
      new ImageMinimizerPlugin({
        // 压缩方式: https://juejin.cn/post/7170338170301579300, 有损/无损等
        // 官网参考: https://webpack.js.org/plugins/image-minimizer-webpack-plugin/
        minimizer: {
