...
功能： 解决样式兼容性问题。PostCSS 是一个强大的CSS处理工具，它使用JavaScript插件来转换CSS样式。这些插件可以让你使用未来的CSS特性、优化CSS文件的大小和性能、检测和修复常见的CSS问题等。它的工作方式类似于JavaScript的Babel，可以被认为是CSS的编译器或转换器。

+ 按照包
+ 在webpack中配置
+ 在package.json中配置browserslist用以设置级别。
